...
private int tourId;
    ...
    public TourListDTO(String tourName, String tourDesc, double tourPrice, int availableSeat, String startDate
            , String endDate, String employeeName, String placeStart, String placeEnd, String tourPlaceName, String image) {
    ...
    public TourListDTO(int tourId, String tourName, String tourDesc, double tourPrice, int availableSeat, String startDate,
                       String endDate, String employeeName, String placeStart, String placeEnd, String tourPlaceName, String image) {
        this.tourId = tourId;
        this.tourName = tourName;
        this.tourDesc = tourDesc;
