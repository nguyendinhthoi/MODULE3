                        ...
                        <div class="col-md-6 col-lg-7 d-flex align-items-center" style="background-color: #bcdff3">
                            <div class="card-body p-4 p-lg-5 text-black">
                                ...
                                <form action="/account?action=login" method="post">
                                    ...
                                    <p class="text-bg-primary" style="text-align: center">${success}</p>

                                    <div class="form-outline mb-4">
                                        <label class="form-label" for="form2Example17" >Tên tài khoản</label>
                                        <input type="text" id="form2Example17" class="form-control form-control-lg" name="user" value="${user}" placeholder="Nhập vào đây.." required/>

                                    </div>

                                    <div class="form-outline mb-4">
                                        <label class="form-label" for="form2Example27">Mật khẩu</label>
                                        <input type="password" id="form2Example27" class="form-control form-control-lg" name="password" value="${pass}" placeholder="Nhập vào đây.." required/>
                                    </div>
                                    ...
                                    <p class="mb-5 pb-lg-2" style="color: #393f81;">Bạn chưa có tài khoản? <a href="/account?action=signup" style="color: #393f81;">Đăng ký ngay.</a></p>
